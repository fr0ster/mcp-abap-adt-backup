export function usage(): string {
  return [
    ...
    '  restore --input <file> [--mode create|update|upsert] [--activate] [--force] [--strict] [--dangerous] [--transport <request>] [--destination name] [--env file] [--auth-root path]',
    ...
    '  list    --input <file> [--format text|json] [--flat]',
